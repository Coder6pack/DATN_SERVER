...
export const GetReviewDetailResSchema = CreateReviewResSchema

export type GetReviewDetailResType = CreateReviewResType
export type GetReviewParamType = z.infer<typeof GetReviewParamSchema>
